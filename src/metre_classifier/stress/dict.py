...
from src.metre_classifier.stress.zalyzniak import ZalyzniakDict

from src.settings import RU_GRAPHEME_STRESS_PATH, RU_GRAPHEME_STRESS_TRIE_PATH, \
     ZALYZNYAK_DICT
...
class StressDict:
    ...
    def __init__(self, language: str="ru", mode: Mode=Mode.GRAPHEMES, raw_dict_path=None, trie_path=None,
                 zalyzniak_dict=ZALYZNYAK_DICT) -> None:
